...
static PCIVendorInfo PciVenTable [] =
{
    { 0x0033, "PC", "Paradyne Corp." } ,
    { 0x003D, "Lockheed Martin", "Lockheed Martin Corp" } ,
    { 0x0070, "Hauppauge", "Hauppauge Computer Works Inc." } ,
    { 0x0100, "NC", "Ncipher Corp. Ltd" } ,
    { 0x0123, "GD", "General Dynamics" } ,
    ...
    { 0x1433, "EE AG", "Eltec Elektronik AG" } ,
    ...
    { 0x14B4, "FBE", "Philips Business Electronics B.V." } ,
...
#define PCI_VENTABLE_LEN    (sizeof(PciVenTable)/sizeof(PCIVendorInfo))
...
static PCIDeviceInfo PciDevTable [] =
{
    ...
    { 0x1255, 0x2110, "VideoPlex", "VideoPlex pci bpc1825 rev a" } ,
    ...
    { 0x12EB, 0x0003, "312EB&REV2", "Aureal Soundcard" } ,
    ...
    { 0x4005, 0x0308, "ALS300+", "PCI Audio Device + modem" } ,
    ...
    { 0x5333, 0x9102, "410", "Inno Savage 2000" } ,
    ...
    { 0x1002, 0x4654, "Mach64 VT", "113--40008-105" } ,
    ...
    { 0x1033, 0x0035, "uPD9210FGC-7EA / �PD720101", "USB 1.0 Host Controller (OHCI compliant)" } ,
    ...
    { 0x1039, 0x1039, "SiS530/620", "PCIVEN_1039&DEV_7012&SUBSYS_200B1631&REV_A03&61AAA01&0&17" } ,
    { 0x1039, 0x1040, "", "" } ,
    { 0x1039, 0x10ec, "", "" } ,
    ...
    { 0x1045, 0xC700, "82C700", "PCIVEN_1045&DEV_C700&SUBSYS_0E1103F4&RE" } ,
    ...
    { 0x104C, 0x8038, "01821028", "GemCore based SmartCard controller" } ,
    ...
    { 0x1057, 0x5600, "52-6116-2A", "Motorola SM 56 Speakerphone Modem" } ,
    ...
    { 0x1057, 0x5600, "WDMMOT8888", "PCI Speakerphone/Data,Fax  Modem" } ,
    { 0x1057, 0x5602, "SM56", "PCI Modem" } ,
    { 0x1057, 0x5608, "52-6116-2A", "PCI Fax Voice Modem" } ,
    ...
    { 0x14F1, 0x2015, "R6793-11", "SoftK56 Speakerphone pci modem" } ,
    ...
    { 0x14F1, 0x2463, "3", "HSF 56k Data/Fax Modem" } ,
    ...
    { 0x13F6, 0211, "pcnet ht2001 9942", "serlio" } ,
    ...
    { 0x10B9, 0x10b9, "M5273 A1 ALI", "pci usb card" } ,
    ...
    { 0x10DE, 0x0057, "nForce4 Ultra", "NVidia Network Bus Enumerator" } ,
    { 0x10DE, 0x0059, "unknown", "unknown" } ,
    ...
    { 0x10DE, 0x0185, "NV25", "GeForce4 MX 4000" } ,
    ...
    { 0x10DE, 0x0253, "NVIDIA Corporation", "Gforce 4200TI 64Mo" } ,
    ...
    { 0x10EC, 0x8029, "RTL8029(AS)", "NE2000 compatible Ethernet" } ,
    ...
    { 0x1102, 0x0002, "8067", "Sound Blaster Live! (Also Live! 5.1) - OEM from DELL - CT4780" } ,
    ...
    { 0x1106, 0x3058, "VT8751", "AC97 Audio Codec (All VIA Chipsets)" } ,
    ...
    { 0x1106, 0x3068, "VT82C686", "ECS HSP56 VIA AC97 Modem riser" } ,
    ...
    { 0x1106, 0x3164, "VT6421", "ATA133 RAID Controller" } ,
    ...
    { 0x1409, 7268, "PCI / ISA IEEE1284 ECP/EPP/SPP/BPP Signal Chips So", "PCI serial port" } ,
    { 0x140B, 0x0610, "", "" } ,
    ...
    { 0x14CF, 0x2920, "FPMC-FIO1-F100-1", "Serial I/O Controller" } ,
    ...
    { 0x14E4, 0x1677, "BCM5751", "Broadcom NetExtreme Gigabit Ethernet" } ,
    ...
    { 0x1179, 0x01179, "0x01179", "pci communication device" } ,
    { 0x1179, 0x0404, "", "" } ,
    ...
    { 0x1179, 0x0804, "PCIVEN_1179&DEV_0804&SUBSYS_FF001179&REV_02", "Toshiba Smart Media Host Controller" } ,
    ...
    { 0x1186, 0x0100, "dl10038c", "Ethernet Adapter" } ,
    ...
    { 0x11AB, 0x4320, "88E8053", "Gigabit Ethernet Controller with Integrated PHY (copper)" } ,
    ...
    { 0x11AB, 0x4361, "88E8053", "Marvell Yukon -EC 88E8036 PCI Express Fast Ethernet Controller" } ,
    { 0x11AB, 0x4362, "88E8050", "Yukon PCI-E Gigabit Ethernet Controller" } ,
    ...
    { 0x11BD, 0xBEBE, "51011810", "Multimedia device" } ,
...
// Use this value for loop control during searching:
#define PCI_DEVTABLE_LEN    (sizeof(PciDevTable)/sizeof(PCIDeviceInfo))
...
static PCIClassInfo PciClassCodeTable[] =
{
...
// Use this value for loop control during searching:
#define PCI_CLASSCODETABLE_LEN  (sizeof(PciClassCodeTable)/sizeof(PCIClassInfo))

static char *  PciCommandFlags [] =
{
    "I/O Access",
    "Memory Access",
    "Bus Mastering",
